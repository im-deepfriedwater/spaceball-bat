...
export var BOTTOM_DESTROY_BOUNDS = 200
export var TOP_DESTROY_BOUNDS = -10
export var RIGHT_DESTROY_BOUNDS = 320
export var LEFT_DESTROY_BOUNDS = -20
...
func _on_Baseball_child_exiting_tree(node):
	BaseballEventsSingleton.emit_signal("destroy_background_baseball")
